...
function createBlogPostCard(blogPost) {
    ...
    postLikesButton.addEventListener('click', async () => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error('Failed to like the blog post. Pleas try again.');
            }
...
function createLikeButton(likes) {
    ...
    heartIcon.src = 'resources/likes.png';
    heartIcon.alt = 'Like';
    ...
    blogPost.comments.forEach((comment, index) => {
        ...
        commentLikesButton.addEventListener('click', async () => {
            ...
            try {
                ...
                if (!response.ok) {
                    throw new Error('Failed to like the comment. Pleas try again.');
                }
